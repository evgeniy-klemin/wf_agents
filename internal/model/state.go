...
// When nil, falls back to the hardcoded default (COMPLETE only).
...
// Terminal phases must be defined via SetTerminalPhases (from config); if not set, no phase is terminal.
